...
export async function updateStoreAction(
  ...
  const colorKeys = ['primary_color', 'secondary_color', 'button_color', 'panel_primary', 'panel_secondary', 'panel_button', 'bg_color', 'dashboard_bg_color', 'dashboard_bg_url', 'dashboard_bg_fit', 'dashboard_bg_position', 'bg_fit', 'bg_position', 'background_url']
